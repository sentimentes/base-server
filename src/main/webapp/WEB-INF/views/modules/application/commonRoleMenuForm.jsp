...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/application/commonRoleMenu/">菜单角色关联管理列表</a></li>
		<li class="active"><a href="${ctx}/application/commonRoleMenu/form?id=${commonRoleMenu.id}">菜单角色关联管理<shiro:hasPermission name="application:commonRoleMenu:edit">${not empty commonRoleMenu.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="application:commonRoleMenu:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="commonRoleMenu" action="${ctx}/application/commonRoleMenu/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">common_interface_authority的id：</label>
			<div class="controls">
				<form:input path="appId" htmlEscape="false" maxlength="64" class="input-xlarge required "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">权限菜单common_menu的id：</label>
			<div class="controls">
