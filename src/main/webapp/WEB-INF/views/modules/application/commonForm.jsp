...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/application/commonAppInfo/commonForm?id=${commonAppInfo.id}">党建工会应用信息添加</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="commonAppInfo" action="${ctx}/application/commonAppInfo/save" method="post" class="form-horizontal" enctype="multipart/form-data">
		...
		<div class="control-group">
			...
			<form:select path="shopId" class="input-xlarge ">
					<form:options items="${fns:getCompanyList('1')}" itemLabel="name" itemValue="id" htmlEscape="false"/>
				</form:select>
