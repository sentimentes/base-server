...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/sys/office/addForm?id=${office.id}&parent.id=${office.parent.id}">机构信息添加</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/addSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
