...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/sys/user/addForm?id=${user.id}">用户信息新增</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/addSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
