...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="sys:menu:add"><li><a href="${ctx}/sys/menu/addForm">菜单添加</a></li></shiro:hasPermission>
	</ul>
			...
			<tbody><c:forEach items="${list}" var="menu">
				<tr id="${menu.id}" pId="${menu.parent.id ne '1'?menu.parent.id:'0'}">
					...
					<shiro:hasPermission name="sys:menu:add">
						<a href="${ctx}/sys/menu/addForm?parent.id=${menu.id}">添加下级菜单</a>
					 </shiro:hasPermission>
					</td>
				</tr>
			</c:forEach></tbody>
