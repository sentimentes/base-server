		...
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					...
					<shiro:hasAnyRoles name="admin,dept">
					<%-- <c:if test="${fns:getAdmin()==true}"> --%>
					<%-- <li><a href="${ctx}/oa/oaNotify/self/message" target="mainFrame"><i class="icon-bell" <c:if test="${fnc:getAhthor()!=null || fnc:getCopyright()!=null}"> style='color:red;'</c:if>></i>&nbsp;  我的通知 <span id="notifyNum2" class="label label-info hide"></span></a></li>--%>
