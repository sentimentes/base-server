...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="addForm?id=${area.id}&parent.id=${area.parent.id}">区域添加</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="area" action="${ctx}/sys/area/addSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:area:add"><input id="nbtnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
