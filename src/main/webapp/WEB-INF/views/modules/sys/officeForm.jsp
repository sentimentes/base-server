...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/office/list?id=${office.parent.id}&parentIds=${office.parentIds}">机构信息列表</a></li>
		<li class="active"><a href="${ctx}/sys/office/form?id=${office.id}&parent.id=${office.parent.id}">机构信息修改</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/updateInfo" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:checkboxes path="companyTypeList" items="${fns:getDictList('company_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
			</div>
		</div> --%>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline"><font color="red">*</font>（必填）请输入排数字</span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">机构类型：</label>
			<div class="controls">
				<form:select path="officeType"  class="input-xlarge">
					<form:option value="1" label="地市州供电公司"/>
					<form:option value="2" label="科研及教培单位"/>
					<form:option value="3" label="直属中心机构"/>
					<form:option value="4" label="省公司"/>
				</form:select>
				<span class="help-inline"><font color="red">*</font>（必填）请选择机构类型</span>
			</div>
		</div>
		 --%>
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline"><font color="red">*</font>（必填）请输入所属公司</span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="fax" htmlEscape="false" maxlength="50" class="fax"/>
			</div>
		</div>
		<div class="control-group">
