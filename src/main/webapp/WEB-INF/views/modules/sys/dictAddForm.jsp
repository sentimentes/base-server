...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/sys/dict/addForm?id=${dict.id}">字典添加</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="dict" action="${ctx}/sys/dict/addSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
