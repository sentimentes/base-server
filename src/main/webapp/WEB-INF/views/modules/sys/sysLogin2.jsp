...
<head>
	...
	<style type="text/css">
      html,body,table{background-color:#3E75C0;width:100%;text-align:center;}.form-signin-heading{font-family:Helvetica, Georgia, Arial, sans-serif, 黑体;font-size:36px;margin-bottom:20px;color:#51b339;}
      ...
      .form-signin .checkbox{margin-bottom:10px;color:#51b339;} .form-signin .input-label{font-size:16px;line-height:23px;color:#fff;}
