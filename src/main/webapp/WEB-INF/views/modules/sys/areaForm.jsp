...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="form?id=${area.id}&parent.id=${area.parent.id}">区域修改</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="area" action="${ctx}/sys/area/updateInfo" method="post" class="form-horizontal">
		<form:hidden path="id"/>
