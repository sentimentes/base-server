...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="sys:dict:add"><li><a href="${ctx}/sys/dict/addForm?sort=10">字典添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="dict">
			<tr>
				...
				<shiro:hasPermission name="sys:dict:edit">
    				...
    				<a href="<c:url value='${fns:getAdminPath()}/sys/dict/addForm?type=${dict.type}&sort=${dict.sort+10}'><c:param name='description' value='${dict.description}'/></c:url>">添加键值</a>
				</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
