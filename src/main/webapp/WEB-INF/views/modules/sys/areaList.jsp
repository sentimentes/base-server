...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="sys:area:add"><li><a href="${ctx}/sys/area/addForm">区域添加</a></li></shiro:hasPermission>
	</ul>
...
<a href="${ctx}/sys/area/addForm?parent.id={{row.id}}">添加下级区域</a> 
</shiro:hasPermission>
			</td>
		</tr>
	</script>
