...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="shoppingmall:goods:gsMenuValue:edit"><li><a href="${ctx}/shoppingmall/goods/tjgsType/form">商品分类细分值添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="tjgsType" action="${ctx}/shoppingmall/goods/tjgsType/form2?id=${id}" method="post" class="breadcrumb form-search">
		<ul class="ul-form">
			<li><label>分类名称：</label>
	...
	<form:form id="listForm" modelAttribute="tjgsType"  action="${ctx}/shoppingmall/goods/tjgsType/addsave?id=${id}" method="post" class="form-horizontal" >
